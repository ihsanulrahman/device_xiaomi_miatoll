...
function blob_fixup() {
    case "${1}" in
        ...
        vendor/lib64/libwvhidl.so)
            ...
            ;;
        vendor/lib64/android.hardware.camera.provider@2.4-legacy.so | vendor/bin/hw/android.hardware.camera.provider@2.4-service_64 | vendor/lib64/camera.device@1.0-impl.so)
            [ "$2" = "" ] && return 0
